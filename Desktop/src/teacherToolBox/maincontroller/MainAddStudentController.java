...
/*
 * The MainAddStudentController class is responsible for handling the graphical theme for its related controller.
 *
 * <p/> Bugs: None
 *
...
public class MainAddStudentController
{
    @FXMLViewFlowContext
    ...
    public void init() throws FlowException, VetoException
    {
        ...
        Flow innerFlow = new Flow(AddStudentController.class);
