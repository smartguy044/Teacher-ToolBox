...
import teacherToolBox.controller.AttendanceController;
import teacherToolBox.controller.SideMenuController;
import javax.annotation.PostConstruct;

/*
 * The MainAttendanceController class is responsible for handling the graphical theme for its related controller.
 *
 * <p/> Bugs: None
 *
...
public class MainAttendanceController
{
    ...
    public void init() throws FlowException, VetoException
    {
        ...
        Flow innerFlow = new Flow(AttendanceController.class);
